...
// //--------------------------------------------------------------------------------
// // pair< pair<Graph*, Graph*>, Graph*> readFormula(char* filename, int MAXCLAUSE){
// tuple< Graph*, Graph*, Graph*> readFormula(char* filename, int MAXCLAUSE){
// //--------------------------------------------------------------------------------
...
// 	Graph* concensus = new Graph(ninclauses, 0);
...
// 				// cerr << "CONCENSUS: " << nclauses+1 << ", " << distance(in_clauses.begin(), c_it) + 1 << endl;
// 			}
// 		}
// 	}
	
// 	fclose(source);
// 	return make_tuple(vig, cvig, concensus);
// }
